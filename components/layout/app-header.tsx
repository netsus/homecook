    ...
    >
      <div className="mx-auto flex min-h-[var(--control-height-xl)] max-w-6xl items-center justify-between gap-3 px-4 md:min-h-[56px] md:px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link aria-label="마이페이지" className="hidden h-11 w-11 items-center justify-center rounded-full text-[var(--foreground)] hover:bg-[var(--ui-sky-50)] lg:inline-flex" href="/mypage" prefetch={false}>
