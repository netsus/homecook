...
export function QaFixtureToolbar() {
  ...
  return (
    <aside className="fixed right-4 bottom-4 z-[60] w-[min(22rem,calc(100vw-2rem))] rounded-[var(--radius-sheet)] border border-[var(--line)] bg-[var(--surface-alpha-96)] p-4 shadow-[0_18px_50px_var(--shadow-color-strong)] backdrop-blur">
      ...
      <div className="mt-4 space-y-3">
        <label className="block">
          ...
          <select
            ...
            className="mt-1 min-h-[var(--control-height-md)] w-full rounded-[var(--radius-card)] border border-[var(--line)] bg-[var(--surface)] px-3 text-sm text-[var(--foreground)]"
            onChange={(event) => {
      ...
      <button
        className="mt-3 min-h-[var(--control-height-md)] w-full rounded-[var(--radius-card)] border border-[var(--line)] bg-[var(--surface)] px-4 text-sm font-semibold text-[var(--foreground)]"
        onClick={() => {
