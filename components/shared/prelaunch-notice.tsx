...
export function PrelaunchNotice() {
  ...
  return (
    <aside aria-label="서비스 준비 안내" className="service-prelaunch-notice flex flex-wrap items-center justify-center gap-x-2 gap-y-0 border-b border-sky-100 bg-sky-50 px-4 py-1.5 text-center text-[11px] leading-5 text-slate-600 sm:text-xs">
