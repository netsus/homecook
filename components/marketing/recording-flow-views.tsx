...
export function Result({ type, onBack, onNext, preview, onPreviewStart, onShare, shareFeedback }: { type: MarketingValidationQuizResult; onBack: () => void; onNext: () => void; preview: boolean; onPreviewStart: () => void; onShare: () => void; shareFeedback: ShareFeedback }) {
...
export function BetaForm({ onBack, onSubmit, getTurnstileToken }: { onBack: () => void; onSubmit: (email: string, token: string) => Promise<string | null>; getTurnstileToken?: () => Promise<TurnstileResult> }) {
