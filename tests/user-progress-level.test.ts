  ...
  it.each([
    ...
    },
    {
      ...
      expected: {
        current_level: 3,
        total_xp: 420,
        current_level_start_xp: 280,
        next_level_start_xp: 540,
        xp_into_current_level: 140,
        xp_to_next_level: 120,
        progress_ratio: 0.5385,
        progress_percent: 54,
      },
    },
    {
      ...
      expected: {
        current_level: 4,
        total_xp: 600,
        current_level_start_xp: 540,
        next_level_start_xp: 880,
        xp_into_current_level: 60,
        xp_to_next_level: 280,
        progress_ratio: 0.1765,
        progress_percent: 18,
      },
    },
