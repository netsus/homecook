        ...
        return {
          ...
          resultJson: {
            visual_source_lines: [
              ...
              { line_index: 6, text: "화면: 파프리카를 반으로 자르고 씨를 제거한다.", start_ms: 8_000, end_ms: 9_000 },
              { line_index: 7, text: "화면: 새우살을 다진 뒤 쪽파, 마늘, 굴소스, 후추와 섞는다.", start_ms: 9_000, end_ms: 10_000 },
              { line_index: 8, text: "화면: 파프리카 안쪽에 부침가루를 묻힌다.", start_ms: 10_000, end_ms: 11_000 },
              { line_index: 9, text: "화면: 새우 반죽을 파프리카에 채운다.", start_ms: 11_000, end_ms: 12_000 },
              { line_index: 10, text: "화면: 계란물을 묻혀 팬에 올린다.", start_ms: 12_000, end_ms: 13_000 },
              { line_index: 11, text: "화면: 앞뒤로 노릇하게 부친다.", start_ms: 13_000, end_ms: 14_000 },
              { line_index: 12, text: "화면: 간장, 알룰로스, 참기름, 통깨를 섞은 양념장을 곁들인다.", start_ms: 14_000, end_ms: 15_000 },
            ],
            recipes: [
              {
                title: "미니 파프리카 새우전",
