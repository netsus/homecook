  ...
  it("finds ESM, CommonJS, re-export, and dynamic loader bypasses in the client graph", () => {
    ...
    expect(inventory.browserSupabaseRuntimeImportViolations).toEqual(
      expect.arrayContaining([
        ...
        expect.objectContaining({
          file: "components/forbidden-commonjs-ambient-const-client.tsx",
          kind: "runtime-require",
          package: "@supabase/supabase-js",
        }),
        expect.objectContaining({
          file: "components/forbidden-commonjs-ambient-function-alias-client.tsx",
          kind: "runtime-require",
          package: "@supabase/storage-js",
        }),
        expect.objectContaining({
          file: "components/forbidden-commonjs-declare-global-function-client.tsx",
          kind: "runtime-require",
          package: "@supabase/supabase-js",
        }),
        expect.objectContaining({
        ...
        expect.objectContaining({
          file: "components/forbidden-commonjs-declare-global-var-client.tsx",
          kind: "runtime-require",
          package: "@supabase/supabase-js",
        }),
        expect.objectContaining({
        ...
        expect.objectContaining({
          file: "components/forbidden-commonjs-erased-overload-client.tsx",
          kind: "runtime-require",
          package: "@supabase/supabase-js",
        }),
        expect.objectContaining({
    ...
    expect(inventory.browserSupabaseRuntimeImportViolations).toHaveLength(28);
    expect(inventory.browserSupabaseRuntimeImportViolations).not.toEqual(
      expect.arrayContaining([
        ...
        expect.objectContaining({
          file: "components/safe-commonjs-local-require-client.tsx",
        }),
        expect.objectContaining({
          file: "components/safe-commonjs-nested-shadow-client.tsx",
        }),
        expect.objectContaining({
          file: "components/safe-commonjs-parameter-require-client.tsx",
        }),
        expect.objectContaining({
