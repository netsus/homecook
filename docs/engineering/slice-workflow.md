...
4. `docs/요구사항기준선-v1.7.1.md` — 해당 슬라이스 요구사항 범위
5. `docs/화면정의서-v1.5.8.md` — 해당 화면 정의
6. `docs/api문서-v1.2.11.md` — 해당 API 섹션
7. `docs/db설계-v1.3.7.md` — 영향받는 테이블
...
6. `docs/api문서-v1.2.11.md` — 해당 섹션 전체
7. `docs/db설계-v1.3.7.md` — 해당 테이블
...
6. `docs/화면정의서-v1.5.8.md` — 해당 화면 정의
...
3. `docs/화면정의서-v1.5.8.md` — 해당 화면 정의
