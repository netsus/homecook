...
2. [CURRENT_SOURCE_OF_TRUTH.md](../sync/CURRENT_SOURCE_OF_TRUTH.md)
3. [docs/workpacks/README.md](../workpacks/README.md)
...
현재 활성 버전은 [CURRENT_SOURCE_OF_TRUTH.md](../sync/CURRENT_SOURCE_OF_TRUTH.md)에서 본다.
...
[agent-workflow-overview.md](./agent-workflow-overview.md)가 아래를 결정한다.
...
- [CURRENT_SOURCE_OF_TRUTH.md](../sync/CURRENT_SOURCE_OF_TRUTH.md)
- [docs/workpacks/README.md](../workpacks/README.md)
- [slice-workflow.md](./slice-workflow.md)
- [agent-workflow-overview.md](./agent-workflow-overview.md)
- [qa-system.md](./qa-system.md)

### OMO / 운영 시스템을 이해할 때

- [workflow-v2/README.md](./workflow-v2/README.md)
- [promotion-readiness.md](./workflow-v2/promotion-readiness.md)
- [omo-base.md](./workflow-v2/omo-base.md)
- [profiles/homecook.md](./workflow-v2/profiles/homecook.md)
- [bookkeeping-authority-matrix.md](./bookkeeping-authority-matrix.md)
