...
- `docs/api문서-v1.2.39.md` §6-2 forbids fixed recipe fixtures for specific `youtube_video_id` during extraction and forbids storing raw video, raw frames, raw provider responses, API keys, secrets, or Recipio data.
