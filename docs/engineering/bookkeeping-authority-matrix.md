...
surface mode 해석은 `omo-canonical-closeout-state.md`를 따른다.
요약하면 현재 baseline은 아래처럼 읽는다.

- `docs/workpacks/README.md`: semi-generated sync target
- `docs/workpacks/<slice>/README.md`: semi-generated sync target
- `docs/workpacks/<slice>/acceptance.md`: semi-generated sync target
- `docs/workpacks/<slice>/automation-spec.json` closeout metadata: declared metadata projection
...
- `## Closeout Sync`, `## Merge Gate`는 generated projection이다.
- `## Actual Verification`은 현재 baseline에서 preserved/manual evidence carrier다.
- 따라서 closeout docs branch는 PR body raw text를 직접 source-of-truth처럼 다루지 않는다.
