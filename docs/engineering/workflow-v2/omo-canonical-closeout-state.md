...
- 현재 baseline: `work-item closeout schema + tracked status projection helper + human-facing projection payload helper + validator guard`까지 구현됐다. README / acceptance / PR body markdown rewrite는 아직 후속 단계다.
