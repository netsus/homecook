...
# 무엇을 먹든 서비스 — API 설계 v1.2.24

> 기준 문서: 요구사항 기준선 v1.7.19 / 화면정의서 v1.5.25 / DB 설계 v1.3.20 / 유저 Flow맵 v1.3.22
...
### Nutrition 공통 payload `v1.2.22`, `v1.2.23`, `v1.2.24` 보강
