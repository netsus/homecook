...
> Source: VoltAgent/awesome-design-md (mirrored in netsus/oh-my-design)
> https://github.com/VoltAgent/awesome-design-md/blob/main/design-md/airbnb/DESIGN.md
> Format: Google Stitch DESIGN.md base spec (sections 1-9). OmD v0.1 Philosophy Layer (sections 10-15) not included in this base version.
