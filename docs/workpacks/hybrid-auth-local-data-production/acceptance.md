...
- architecture-pivot correction regression: 변경 연관 `12 files`에서 `203 passed / 2 skipped`, fresh PostgreSQL/Storage isolated runtime `10 passed`(51.60초), source/import + bundle 보조 canary `19 passed`를 3회 반복(`3.77s / 3.76s / 3.73s`)
- full regression: `pnpm lint`, `pnpm typecheck`, `pnpm test` (`4715 passed / 226 skipped`), `pnpm test:product` (`2421 passed / 128 skipped`), `pnpm build`, `pnpm validate:workpack`, `git diff --check`
