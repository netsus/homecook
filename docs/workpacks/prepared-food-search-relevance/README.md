...
- [ ] transaction-compatible index DDL and exact-derived concurrent prebuild foundation <!-- omo:id=delivery-search-index-foundation;stage=2;scope=backend;review=3,6 -->
