...
- blocker:
  - 공식 v1.7.19/v1.5.25/v1.3.22/v1.3.20/v1.2.24와 shape 불일치
...
- public field/endpoint/status/error code는 새로 추가하지 않고 official v1.7.19/v1.5.25/v1.3.22/v1.3.20/v1.2.24가 이 결정을 잠근다.
