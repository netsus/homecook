...
- [ ] 2026-05-12 계약 기준 RECIPEBOOK_DETAIL 카드에 태그, 조회수, 조리시간, 기본 인분이 표시된다 <!-- omo:id=accept-recipebook-card-meta-v124;stage=4;scope=frontend;review=5,6 -->
...
### Vitest
- [ ] GET /recipe-books/{book_id}/recipes 응답 형식, cursor pagination, owner-guard, v1.2.4 card metadata 검증 <!-- omo:id=accept-vitest-detail-list-v124;stage=2;scope=backend;review=3,6 -->
...
### Playwright
- [ ] RECIPEBOOK_DETAIL 진입, 레시피 목록 metadata 표시, 제거, empty 전환 브라우저 테스트 <!-- omo:id=accept-playwright-flow-v124;stage=4;scope=frontend;review=5,6 -->
