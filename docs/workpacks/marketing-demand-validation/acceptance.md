...
- [x] Stage 6 운영 테스트가 PII 비노출 stdout, safe artifact path, CSV injection 방지, dry-run/confirm purge, paid allowlist cohort, Wilson interval, retention internal scope를 고정한다 <!-- omo:id=accept-stage6-operations-lock;stage=4;scope=shared;review=6 -->
