...
| S8 | contract-evolution PR (화면정의서 v1.3.1) merge 확인 | ✅ PR #136 merged 2026-04-17 |
...
| C3 | 비로그인 → 로그인 게이트 → 로그인 성공 후 바텀시트 자동 복귀 (return-to-action) | 수동 확인 (slice-06 기존 e2e 커버, 이번 변경이 해당 경로에 영향 없음) |
