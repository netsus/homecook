...
>
> Official authority is the current tuple `v1.7.30/v1.5.34/v1.3.32/v1.3.32/v1.2.37`, the approved Cooking Plan / Meal Log master-plan SHA-256 `d4d0fb39e80eeffc8b1e73ad92f0d91a35a9b6adc57a556ea8c9ec6ecffa951d` (1,018 lines), and relock base/tree `8ba3fa5a2a198eb4f9c19d59cea5f6ccc52fdd4f` / `6b67f32a3a404b2d7d60a9c231a394c2e17c6c9a`.
...
- [ ] #10 adds no DB schema/migration/RLS/RPC/public endpoint/field/status; Stage 2 backend implementation is N/A except compatibility contract tests <!-- omo:id=accept-planner-shell-no-backend-scope;stage=2;scope=shared;review=3,6 -->
...
- [ ] focus, keyboard order, tab semantics, accessible names, Arrow Left/Right, Home/End and reduced motion are correct <!-- omo:id=accept-planner-shell-a11y;stage=4;scope=frontend;review=5,6 -->
...
- [ ] unauthenticated access keeps existing `401 UNAUTHORIZED`; retained legacy delete keeps existing `401 UNAUTHORIZED`, `403 FORBIDDEN` and `404 RESOURCE_NOT_FOUND` without a new error code <!-- omo:id=accept-planner-shell-errors;stage=2;scope=shared;review=3,6 -->
...
- [ ] 390px/320px/desktop evidence covers 16px horizontal padding, minimum 44px targets, density, scroll, focus, keyboard, virtual-keyboard occlusion, back and no page overflow <!-- omo:id=accept-planner-shell-design-evidence;stage=4;scope=frontend;review=5,6 -->
