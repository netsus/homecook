...
- [ ] an empty slot shows `비어 있음` and keeps current behavior/future-slice decision; no new add affordance or CTA is implemented unless separately approved as a Contract Evolution Candidate <!-- omo:id=accept-planner-shell-empty-slot;stage=4;scope=frontend;review=5,6 -->
