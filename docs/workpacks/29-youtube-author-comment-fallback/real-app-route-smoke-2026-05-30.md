...
- Run id: `youtube-real-app-route-smoke-2026-05-30-1ccaf5b9`
- Started at: `2026-05-29T15:40:39.973Z`
...
- Raw artifact: `/Users/shj/2025/2026/homecook1/.artifacts/youtube-real-app-route-smoke/youtube-real-app-route-smoke-2026-05-30-1ccaf5b9/report.json`
- Screenshot dir: `/Users/shj/2025/2026/homecook1/.artifacts/youtube-real-app-route-smoke/youtube-real-app-route-smoke-2026-05-30-1ccaf5b9`
...
| 4 | structured | `o1UIiJQeviQ` | description | yes | success | session:consumed<br>recipe:yes<br>ingredients:5<br>steps:1 | recipe, session | provider closeout: description signal and author recipe signal |
...
| 10 | semi_structured | `_PUFZM6vZQw` | comment | yes | success | session:consumed<br>recipe:yes<br>ingredients:6<br>steps:11 | recipe, session | provider closeout: no description signal, author recipe signal |
...
| 19 | shorts_weak | `FSOj5BPSM-Q` | comment | yes | success | session:consumed<br>recipe:yes<br>ingredients:8<br>steps:5 | recipe, session | provider closeout: no description signal, author recipe signal |
...
| 23 | multi_component | `VdEbuusFyRI` | comment | yes | blocked | session:draft<br>recipe:-<br>ingredients:0<br>steps:0 | session | requirements: 등록하려면 아래 항목을 확인해주세요. 만들기 |
