# YouTube Real App-Route Smoke - 2026-05-29

## Scope

- Run id: `youtube-real-app-route-smoke-2026-05-29-5b5490eb`
- Started at: `2026-05-29T03:16:58.439Z`
- App URL: `http://127.0.0.1:3200`
...
- Raw artifact: `/Users/shj/2025/2026/homecook1/.artifacts/youtube-real-app-route-smoke/youtube-real-app-route-smoke-2026-05-29-5b5490eb/report.json`
- Screenshot dir: `/Users/shj/2025/2026/homecook1/.artifacts/youtube-real-app-route-smoke/youtube-real-app-route-smoke-2026-05-29-5b5490eb`
...
| register attempted | 13/30 |
| register succeeded | 13/30 |
| cleaned recipes | 13 |
| cleaned sessions | 30 |

## Findings

- Registerable drafts succeeded 13/13; no enabled register action failed after duplicate ingredient rows were allowed.
- `j0v1GCA3fxk` reached review after validate fell back from oEmbed preview to YouTube Data API.
- The remaining 17 blocked drafts are not register failures: most are empty/partial extraction or missing first step. The only unresolved dictionary item in this run is `배`.
...
| 4 | structured | `o1UIiJQeviQ` | description | yes | success | session:consumed<br>recipe:yes<br>ingredients:4<br>steps:1 | recipe, session | provider closeout: description signal and author recipe signal |
...
| 10 | semi_structured | `_PUFZM6vZQw` | author_comment | yes | success | session:consumed<br>recipe:yes<br>ingredients:5<br>steps:11 | recipe, session | provider closeout: no description signal, author recipe signal |
| 11 | weak | `-sxyXlAFEhM` | description | yes | success | session:consumed<br>recipe:yes<br>ingredients:9<br>steps:21 | recipe, session | provider closeout: description signal and author recipe signal |
...
| 19 | shorts_weak | `FSOj5BPSM-Q` | author_comment | yes | success | session:consumed<br>recipe:yes<br>ingredients:7<br>steps:5 | recipe, session | provider closeout: no description signal, author recipe signal |
...
| 23 | multi_component | `VdEbuusFyRI` | author_comment | yes | blocked | session:draft<br>recipe:-<br>ingredients:0<br>steps:0 | session | requirements: 등록하려면 아래 항목을 확인해주세요. 만들기 확인 필요한 재료 |
...
| 30 | baking_or_global | `nOFkL1cGGjE` | author_comment | yes | success | session:consumed<br>recipe:yes<br>ingredients:6<br>steps:4 | recipe, session | provider closeout: no description signal, author recipe signal |

## Cleanup

- Deleted recipe IDs: 13
