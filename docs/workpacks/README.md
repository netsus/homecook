...
| `recipe-content-snapshot-future-propagation` | in-progress | Stage 2/3 PR #1278 reviewed head `9eb1ebd8`는 `ef5903b1`로 merge됐다. Draft Stage 4 PR #1281 exact implementation head `1096494a`는 실제 entrypoint/owner editor와 AUTH-M01/M02/AUTH-M03 repair를 포함하고, fresh final authority task `019fca76-eb5f-79a3-8d2a-a2f46a5591d3`가 `0/0/0`으로 승인해 Design Status는 confirmed다. Stage 6, Manual/server-Mac/OAuth, activation은 pending이다 |
...
| 7 | C | `recipe-content-snapshot-future-propagation` | in-progress | #4 PR #1218 + #6 PR #1274 + `cook-mode-whole-board` PR #711 runtime merged; Stage 2/3 PR #1278 merge `ef5903b1`; Contract Evolution PR #1282 + re-lock PR #1283의 공식 tuple을 Draft Stage 4 PR #1281 exact implementation head `1096494a`에서 actual owner editor와 AUTH-M01/M02/AUTH-M03 repair까지 구현했다. fresh final authority `0/0/0`, Design Status confirmed; Stage 6, Manual/server-Mac/OAuth, activation pending |
