...
| `recipe-snapshot-authority-foundation` | in-progress | PR #1218/#1219 구현과 PR #1231/#1232/#1233/#1251 hybrid evidence를 역사로 보존한다. Active target은 local Supabase Auth+DB+Storage 단일 authority이며 snapshot-specific full-local verifier는 Stage 2 planned/not implemented 상태다 |
...
| 4 | B | `recipe-snapshot-authority-foundation` | in-progress | #2 PR #1256 implementation + PR #1262 Stage 6 closeout merged, #3 Storage/outbox runtime merged. PR #1218/#1219 구현과 PR #1231/#1232/#1233/#1251 hybrid evidence는 역사로 보존하며, local Auth+DB+Storage active gate의 snapshot Stage 2 verifier·Train B·Manual Only 검증은 미완료 |
