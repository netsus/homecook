...
| `cooking-meal-log-cross-slice-release-qa` | docs | Stage 1 exact head `2c33b38cf9f3badb72d610ad7a47abe70bf8907f` / tree `23fab93ab372174b9f531cf3414b348b1a724894`에 대해 네 독립 task가 `APPROVE 0/0/0`, drift `0`이다. Stage 2 remains not started/pending이며 runtime/full 8-lane 287041/Manual/activation은 완료로 투영하지 않는다 |
...
| 14 | F | `cooking-meal-log-cross-slice-release-qa` | docs | Stage 1 exact head `2c33b38cf9f3badb72d610ad7a47abe70bf8907f` / tree `23fab93ab372174b9f531cf3414b348b1a724894`에 대해 네 독립 task가 `APPROVE 0/0/0`, drift `0`이다. Stage 2 remains not started/pending이며 runtime/full 8-lane 287041/Manual/server-Mac/OAuth/device/AT/full-WCAG/local-production/rehearsal/backup-restore/cutover/capability/R/R+1/R+2/required-key/activation은 pending이다 |
