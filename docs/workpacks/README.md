...
| `personal-recipe-editor-decoupling` | in-progress | PR #1238 backend 경계와 PR #1243 capability-off shell/UI evidence, PR #1246 hybrid verifier는 역사로 보존한다. Full-local Stage 2 verifier는 TDD 구현됐고 독립 Stage 3 → existing shell Stage 4 재검증 → lightweight Stage 5 → merged-exact Stage 6과 activation/Manual Only 증거는 pending이다 |
