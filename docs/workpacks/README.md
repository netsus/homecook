...
| `legacy-product-compat` | docs | #13 Stage 1 exact-six relock: official tuple v1.7.32/v1.5.36/v1.3.34/DB v1.3.34/API v1.2.39와 tracked plan `d4d0fb39`/1,018 lines를 잠근다. #10 PR #1331 merge `2185b59d`와 #12 PR #1361 merge `4264fe6b`의 runtime dependency fulfilled; Manual/server-Mac/OAuth, device/AT/full WCAG, capability, R/R+1/R+2, production/activation은 pending이다. implementation/evaluation not_started, verification pending, auto-merge false |
...
| 13 | E | `legacy-product-compat` | docs | #10 + #12 runtime dependency fulfilled; broader Manual/activation pending |
