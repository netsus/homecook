...
| `10a-shopping-detail-interact` | in-progress   | 장보기 상세 조회, 체크 토글, 제외/되살리기 (`exclude→uncheck` 규칙 포함)                                         |
...
| `baemin-style-tokens-additive` | in-progress | h6 ✅ | 배민 스타일 후속 전환용 additive CSS token foundation — 기존 C2 값 변경 없음, 컴포넌트 적용 없음 |
