...
| `service-brand-image-assets` | in-progress | 선택한 파란 `무먹` 심볼을 HOME/non-HOME header, favicon, 설치/Apple 아이콘, OG/Twitter metadata에 적용하고 Ubuntu 기준선/current-head CI를 검증 중 |
