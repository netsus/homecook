...
| `ingredient-nutrition-full-coverage` | in-progress | 2026-07-17 public-sharing official docs = merged, `public-nutrition-source-acquisition` = merged, `ingredient-nutrition-conversion-model` = merged | Successor 1; Stage 2 backend TDD is active on `feature/be-ingredient-nutrition-full-coverage` while Stage 3 independent review remains pending |
