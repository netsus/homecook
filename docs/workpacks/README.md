...
| 5 | C | `personal-recipe-editor-decoupling` | in-progress | #3; `31-recipe-media-tags` merged; `36e-recipe-tags-frontend` merged; #4는 predecessor 아님. PR #1238, capability-off PR #1243 merge `6565c2a8`, hybrid verifier PR #1246은 historical evidence. Full-local Stage 2/3, existing shell Stage 4와 independent no-visual-drift Stage 5 완료; Stage 6 lifecycle과 Manual Only activation은 pending |
