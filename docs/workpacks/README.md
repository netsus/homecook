...
| `34e-growth-profile-visual-polish` | docs | 34d 후속 polish: MYPAGE 성장 프로필을 실제 통합 header로 재구성하고 desktop blank-card regression, badge emblem 품질, `집밥 러너` no-footwear visual을 수정 |
