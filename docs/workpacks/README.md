...
| `prepared-food-planner-entry` | in-progress | 완제품을 Recipe Meal과 분리해 플래너에 추가/수정/삭제하고 shopping/cooking/leftover/XP에서 구조적으로 제외한다 |
...
| `prepared-food-planner-entry` | in-progress | `prepared-food-catalog` = merged, `05-planner-week-core` = merged |
