...
| `11-shopping-reorder`          | in-progress | 장보기 순서 변경과 미완료 리스트 reorder persistence                                                             |
...
| `baemin-style-recipe-detail-retrofit` | docs | h6 ✅ | RECIPE_DETAIL anchor screen 배민 스타일 시각적 리트로핏 — 정보 구조 보존, 토큰 교체, COOKING_METHOD_TINTS color-mix() 전환, H5 modal decisions 보존 |
