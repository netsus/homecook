...
| `personal-recipe-customization-write-core` | in-progress | Stage 2 dormant backend core exact head `5b96e9be`가 독립 code/quality 및 security/DB Stage 3 재리뷰에서 각각 APPROVE 0/0/0을 받았다. PR #1274는 Draft/pre-merge이며 Manual Only와 #7/#8 activation은 pending이다 |
...
| 6 | C | `personal-recipe-customization-write-core` | in-progress | #2 + #3 + #4 + #5 runtime merged; Stage 2 exact head `5b96e9be` independent Stage 3 dual APPROVE, Draft PR #1274 merge/Manual Only/#7/#8 activation pending |
