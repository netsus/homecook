...
|-------|--------|------|------|
| `H2-planner-week-v2-redesign` | `in-progress` | H4 ✅ | PLANNER_WEEK day-card 리디자인, 가로 스크롤 제거, 2일 이상 mobile overview |
| `h3-planner-add-sync` | `docs` | H4 ✅ | RECIPE_DETAIL planner-add 바텀시트 × day-card baseline sync, 성공 후 동작 확정 |
