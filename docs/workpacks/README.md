...
| `recipe-snapshot-authority-foundation` | in-progress | PR #1218/#1219 구현과 PR #1231/#1232/#1233/#1251 hybrid evidence를 역사로 보존한다. Full-local Stage 3 deployable app/runtime authority PR #1263은 병합됐지만 activation/Manual Only와 snapshot-specific Stage 2 verifier는 pending/not implemented 상태다 |
