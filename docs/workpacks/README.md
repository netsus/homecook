...
| `public-prepared-food-catalog-import` | docs | 검수된 공공 완제품을 batch-only local catalog로 승격하고 stable key, attribution, rollback을 보존한 검색 경로를 연다 |
...
| `public-prepared-food-catalog-import` | docs | 2026-07-17 public-sharing official docs = merged, `prepared-food-catalog` = merged | Successor 3; Stage 1 workpack docs authored, independent docs gate review and merge required before implementation |
