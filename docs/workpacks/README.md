...
| `product-ingredient-link-foundation` | in-progress | 승인 Contract Evolution PR #1254와 Stage 2/3 backend/data PR #1255 merge `d30ee2c8` 완료. PR #1256 Stage 4 HOME/PANTRY consumer TDD·desktop/390/320 fixture evidence와 exact head `04d4b26c` Stage 5 `P0/P1/P2=0/0/0` 승인을 수집했으며 Stage 6와 merge는 pending. 기존-schema/full-hybrid/query-plan 운영 증거는 Manual Only |
...
| 2 | B | `product-ingredient-link-foundation` | in-progress | F0 + #3, link-only subset/verifier, Contract Evolution과 Stage 2/3 PR #1255 merge `d30ee2c8` 완료. PR #1256 Stage 4 구현과 Stage 5 승인은 완료; Stage 6/merge는 pending이고 production account cleanup·기존-schema/full-hybrid/query-plan은 Manual Only |
