...
| `recipe-content-snapshot-future-propagation` | in-progress | Stage 1 PR #1081과 runtime predecessors #1218/#1274/#711은 병합됐다. Stage 2는 계약이 잠긴 DB·보안·동시성 RED부터 시작하며, v2 start/read/cancel과 recipe PATCH/DELETE 성공 `data` 필드명은 contract-evolution 전까지 구현하지 않는다 |
...
| 7 | C | `recipe-content-snapshot-future-propagation` | in-progress | #4 PR #1218 + #6 PR #1274 + `cook-mode-whole-board` PR #711 runtime merged; public success `data` exact field names remain contract-evolution blocked |
