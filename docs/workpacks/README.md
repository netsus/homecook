...
| `baemin-prototype-home-porting` | in-progress | h7 | HOME prototype direct porting — hero, promo strip, inline chips, HOME bottom tab까지 HOME에 승격 |
...
| `desktop-home-pantry-parity` | docs | h7 | Desktop prototype 홈+팬트리 모바일 기능 parity — DesktopHome에 검색/INGREDIENT_FILTERS/THEMES 카러셀/플래너 프로모/정렬 키 수정, DesktopPantry에 검색/추가 버튼 연결. 프로토타입 전용 |
