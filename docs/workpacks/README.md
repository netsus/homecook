...
| `product-ingredient-link-foundation` | in-progress | 승인 Contract Evolution PR #1254와 Stage 2/3 backend/data PR #1255 merge `d30ee2c8` 완료. Stage 4 existing HOME/PANTRY consumer TDD와 desktop/390/320 fixture browser evidence를 `feature/fe-product-ingredient-link-foundation`에서 수집했으며 independent Stage 5/6와 full-lifecycle closeout은 pending |
...
| 2 | B | `product-ingredient-link-foundation` | in-progress | F0 + #3, link-only subset/verifier, Contract Evolution과 Stage 2/3 PR #1255 merge `d30ee2c8` 완료. Stage 4 HOME/PANTRY consumer 구현·fixture browser evidence 수집 완료; Stage 5/6와 production account cleanup activation은 pending/Manual Only |
