...
| `prepared-food-catalog` | in-progress | 승인 public 완제품 + 사용자 private manual 제품 catalog, immutable nutrition version, owner/public read-only/soft-delete 정책을 구현한다 |
...
| `prepared-food-catalog` | in-progress | `ingredient-nutrition-conversion-model` = merged |
