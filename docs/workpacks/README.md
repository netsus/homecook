...
| `h7-baemin-prototype-parity-direction` | `HOME`, `RECIPE_DETAIL`, `PLANNER_WEEK`, modal family | Baemin prototype near-100% parity program. PLANNER_WEEK planner-level "가로 스크롤 없음" lock 제거 승인(2026-04-27) | workpack 작성 / 승인 대기 | `baemin-prototype-parity-foundation`, `baemin-prototype-home-parity`, `baemin-prototype-recipe-detail-parity`, `baemin-prototype-planner-week-parity-contract`, `baemin-prototype-planner-week-parity`, `baemin-prototype-modal-overlay-parity`, `baemin-prototype-parity-polish-closeout` |
...
| `h7-baemin-prototype-parity-direction` | planned | h7 | 프로토타입 near-100% parity 공식 방향 게이트 — supersession matrix, scoring method, exclusions, rollout lock |
| `baemin-prototype-parity-foundation` | future | h7 | 3-way capture, fixture, material/reference foundation |
| `baemin-prototype-home-parity` | future | h7 | HOME body prototype parity — target score `>=95`, blocker 0 |
| `baemin-prototype-recipe-detail-parity` | future | h7 | RECIPE_DETAIL body prototype parity — target score `>=95`, blocker 0 |
| `baemin-prototype-planner-week-parity-contract` | future | h7 | PLANNER_WEEK prototype-priority contract/evidence target sync |
| `baemin-prototype-planner-week-parity` | future | h7 | PLANNER_WEEK body prototype parity — target score `>=94`, blocker 0 |
| `baemin-prototype-modal-overlay-parity` | future | h7 | Modal/sheet overlay prototype parity — target score `>=93`, blocker 0 |
