...
| `marketing-demand-validation-round2` | docs | `/beta/r2/recording`, `/beta/r2/homeflow`, 메뉴 direct/apply 분기, 회차·주제 분리, 4문항 4결과 보존을 Stage 1 lock. v1 계약 보존(기존 `/beta`)과 v2 핵심 계약 상호배타 유지 |
