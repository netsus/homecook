...
| `desktop-planner-parity` | in-progress | h7 | Desktop prototype planner 주간 요약 parity — 모바일 요약 카드(total/cooked/shopped/registered)를 DesktopPlanner에 추가, 날짜 범위 seed 정합. 프로토타입 전용 |
