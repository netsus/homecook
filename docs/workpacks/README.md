...
| `youtube-extraction-truthful-progress-eta` | docs | 기존 `YT_IMPORT_BACKGROUND`의 경과시간 기반 progress를 실제 stage floor + gated ETA range로 교체하는 Stage 1 문서. 새 public endpoint/WebSocket/SSE 없이 기존 5초 polling과 retry/notification 계약 유지 |
