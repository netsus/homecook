...
| `10b-shopping-share-text`      | in-progress | 장보기 공유 텍스트 생성 (`is_pantry_excluded=false` 항목만 포함)                                                 |
...
| `baemin-style-home-retrofit` | docs | h6 ✅ | HOME anchor screen 배민 스타일 시각적 리트로핏 — H1 정보 구조(D1-D4) 보존, 토큰 교체, 공유 프리미티브 소비 |
