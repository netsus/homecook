...
| `meal-log-ui` | in-progress | Stage 2 typed meal-log adapter와 shared policy 회귀 테스트를 구현 중이며, Stage 4 MEAL_LOG 화면·add sheet·runtime authority는 후속 작업이다 |
...
| 12 | E | `meal-log-ui` | in-progress | #9 + #10. canonical design prerequisite: generator `019ffb5f-b4be-7153-84b8-e4f341bd5ae5` head/tree `1b44bb7238cc6d0381805585f371fe12e0cb90f0`/`851ceaa34835b7f5288590a3f0b74f7666e50eb7`; superseded history repair/re-review `019ffb73-1f48-7832-8d18-b043209f208a`/`019ffb81-4bad-7353-b92b-add4924a4a40` at `910d14e99e71c9a05aa623cbf0a9c3b6f1f9456b`/`1da1a186b99044d12fc9a940321a9bbefe44ae07`; current P1-ML-05 repair `019ffbbc-d4f1-7730-be56-0d8d6d28ce8c`, design head/tree/blob `e2959ef523e57770a4cb2b490f7b00a972ab8845`/`7932fc6d026d9f2c0aa963041efcf315be12c9e9`/`9bade6235acd9c6f60d128216260d9c0408718c2`; fresh review `019ffbc5-0c4a-7b11-afd9-6346a76b762c`, critique commit/tree `4e1bdaae2335fd41bb46db1ede5d835a2f164faa`/`467f698b61775eea81487aaddf2aeac91bea1e00`, `APPROVE P0/P1/P2 0/0/0`. Stage 1 merge `d5164357e85772833518c5e4766cef020735b7f1`; independent internal1.5/security/API/five-axis reviews `APPROVE 0/0/0`. every edit save from a deleted/null origin requires explicit current active owner meal column selection regardless of quantity/source/date/timezone fields; save fail-closed until selection; server replaces meal_plan_column_id + slot_name_snapshot. DELETE remains no relocation. Stage 2 typed adapter/shared policy TDD 진행 중; Stage 4 runtime/authority와 Manual/activation은 pending |
