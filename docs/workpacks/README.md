...
| `recipe-content-snapshot-future-propagation` | in-progress | Stage 2/3 PR #1278 reviewed head `9eb1ebd8`는 `ef5903b1`로 merge됐다. Contract Evolution PR #1282 merge `7e316e87`의 새 official tuple(v1.7.29/v1.5.33/v1.3.31/DB1.3.31/API1.2.35)을 fresh Stage 1에서 재잠금한다. Draft Stage 4 PR #1281 head `6cfcb307`은 구현 evidence가 있으나 entrypoint repair가 필요하다. Design Status는 pending-review/temporary이며 authority report, Stage 5/6, Manual/server-Mac, activation은 pending이다 |
...
| 7 | C | `recipe-content-snapshot-future-propagation` | in-progress | #4 PR #1218 + #6 PR #1274 + `cook-mode-whole-board` PR #711 runtime merged; Stage 2/3 PR #1278 merge `ef5903b1`; Contract Evolution PR #1282 merge `7e316e87`의 v1.7.29/v1.5.33/v1.3.31/DB1.3.31/API1.2.35 재잠금 중. Draft Stage 4 PR #1281 head `6cfcb307` entrypoint repair, authority/Stage 5/6, Manual/server-Mac, activation pending |
