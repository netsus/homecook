...
| `desktop-mypage-parity` | docs | h7 | Desktop prototype mypage 모바일 메뉴 parity — 모바일 MyPageScreen의 9개 메뉴(emoji 아이콘, onGoPage 라우팅)를 DesktopMyPage aside에 추가. 프로토타입 전용 |
