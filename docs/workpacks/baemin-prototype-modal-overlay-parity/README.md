...
- Notes: h7 parity program의 scored overlay slice. Stage 5 public review와 별도 Codex `product-design-authority` 작업 통과 필요. 기존 H5 modal family design docs, baemin-style-modal-system-fit authority 결과를 base로 활용.
