...
# 집밥 서비스 — API 설계 v1.2.11

> 기준 문서: 요구사항 기준선 v1.7.1 / 화면정의서 v1.5.8 / DB 설계 v1.3.7 / 유저 Flow맵 v1.3.8
> 작성: 킴실장
...
> **v1.2.11 총계**: 55개 (taxonomy contract lock, 신규 endpoint 없음)
