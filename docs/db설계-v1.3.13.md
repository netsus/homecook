...
| notification_type | text | NOT NULL | `xp_awarded` / `badge_unlocked` / `quest_completed` |
...
| user_progress_notifications | `(user_id, seen_at, created_at DESC)` | unseen toast/notification 조회 `33c-gamification` |
...
| 25 | user_badge_awards | 사용자 성장/배지 `33c-gamification` |
| 26 | user_quest_progress | 사용자 성장/퀘스트 `33c-gamification` |
| 27 | user_progress_notifications | 사용자 성장/notification `33c-gamification` |
| 28 | admin_members | Admin Foundation `v1.3.8` |
| 29 | operational_events | Admin Foundation `v1.3.8` |
| 30 | admin_audit_logs | Admin Foundation `v1.3.8` |
| 31 | youtube_extraction_candidates | YouTube 다중 후보 `2026-05-30` |
