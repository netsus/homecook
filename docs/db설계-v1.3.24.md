...
- scope별 RLS/moderation predicate를 먼저 적용한 뒤 typed union 전체를 integer relevance tuple `(full coverage, exact, prefix, compact substring, trigram bucket, source priority, popularity, stable id)`로 정렬한다.
