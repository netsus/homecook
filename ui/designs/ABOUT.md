...
> 기준 문서: 화면정의서 v1.5.19 §1-a / 요구사항 기준선 v1.7.12 §1-1-a / 유저Flow맵 v1.3.19 §①-a
...
- 작은 eyebrow는 `무먹 가이드`, 유일한 H1은 `무엇을 먹든, 계획은 한곳에서`로 사용한다. 둘을 같은 크기·위계로 중복 강조하지 않는다.
