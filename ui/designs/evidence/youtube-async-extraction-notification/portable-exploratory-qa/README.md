...
- 이 bundle은 capture source `2113dacdbb464f6422424324a38823e8c3d6933a` / `ed823a064774dee538df8cde47c483af08efa7dc`에서 `2026-08-14T06:52:00Z`에 잠근 3217의 81개 Playwright 실행과 30개 screenshot 결과를 사용한다. current implementation `3c1e0d422b0849f7f086d1b7fefc55bac41eee60` / `ee5e40de5c9de3e5bbbda766d233c7f118a2df3f`의 마지막 UI delta는 최초 closed mount의 focus guard뿐이며 rendered markup/style/copy/geometry와 screenshot generator를 바꾸지 않는다. RED-to-GREEN component regression과 current-head 전체 gate로 non-visual 변경을 검증해 PNG를 재사용했다.
