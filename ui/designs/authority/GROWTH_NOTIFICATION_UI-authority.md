...
흐르지 않고, archive는 읽기 전용 기록 surface로 유지된다.
...
> - archive surface: `ui/designs/evidence/34c-growth-notification-ui/archive-surface.png`
> - archive empty state: `ui/designs/evidence/34c-growth-notification-ui/archive-empty.png`
> - archive pagination: `ui/designs/evidence/34c-growth-notification-ui/archive-pagination.png`
...
| Interaction clarity | pass | 닫기 버튼과 `+N개의 새 소식 확인` summary가 명확하고, archive는 `더 보기` pagination만 제공한다. |
| Visual hierarchy | pass | level_up은 brand-filled tone으로 가장 강하게 보이고, badge/quest/xp는 border tone으로 단계 차이가 난다. |
