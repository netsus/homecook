...
> - `ui/designs/evidence/marketing-demand-validation-round2/final-authority-01a08f0c/direct/recording-320-MENU-initial.png`
> - `ui/designs/evidence/marketing-demand-validation-round2/final-authority-01a08f0c/direct/homeflow-390-MENU-initial.png`
...
알림 primary, 예시 secondary, 의견 tertiary를 한 문서에서 구분한다. 베타 준비·실제 서비스 출시 전 안내와 자유 선택 문구가 유지된다. 기본390에서 세 버튼 하단은 569.70px, narrow recording561.64px/homeflow585.64px이다. homeflow320×568에서는 세 번째 버튼의 끝부분이 아래로 이어지지만 주 CTA가 보이고 자연 스크롤로 접근하며 설계 목표 y≤600을 충족한다. 활동0/3 압박은 없다.
...
![recording-390-MENU-initial.png](../../../ui/designs/evidence/marketing-demand-validation-round2/final-authority-01a08f0c/direct/recording-390-MENU-initial.png)

![recording-320-MENU-initial.png](../../../ui/designs/evidence/marketing-demand-validation-round2/final-authority-01a08f0c/direct/recording-320-MENU-initial.png)

![homeflow-390-MENU-initial.png](../../../ui/designs/evidence/marketing-demand-validation-round2/final-authority-01a08f0c/direct/homeflow-390-MENU-initial.png)

![homeflow-320-MENU-initial.png](../../../ui/designs/evidence/marketing-demand-validation-round2/final-authority-01a08f0c/direct/homeflow-320-MENU-initial.png)
