...
const ADDITIVE_SOURCES = [
  ...
  {
    manifestPath:
      process.env.SECURITY_FUNCTION_RECIPE_IMAGE_UPLOAD_MANIFEST_PATH
      ?? path.join(
        REPO_ROOT,
        "docs/security/recipe-image-upload-reservation-security-function-authorization-manifest.json",
      ),
    migrationPath:
      process.env.SECURITY_FUNCTION_RECIPE_IMAGE_UPLOAD_MIGRATION_PATH
      ?? path.join(
        REPO_ROOT,
  ...
  {
    manifestPath:
      process.env.SECURITY_FUNCTION_RECIPE_IMAGE_CANCEL_MANIFEST_PATH
      ?? path.join(
        REPO_ROOT,
        "docs/security/recipe-image-cancel-cas-security-function-authorization-manifest.json",
      ),
    migrationPath:
      process.env.SECURITY_FUNCTION_RECIPE_IMAGE_CANCEL_MIGRATION_PATH
      ?? path.join(
        REPO_ROOT,
  ...
  {
    manifestPath:
      process.env.SECURITY_FUNCTION_RECIPE_IMAGE_ATTACH_MANIFEST_PATH
      ?? path.join(
        REPO_ROOT,
        "docs/security/recipe-image-attach-cas-security-function-authorization-manifest.json",
      ),
    migrationPath:
      process.env.SECURITY_FUNCTION_RECIPE_IMAGE_ATTACH_MIGRATION_PATH
      ?? path.join(
        REPO_ROOT,
  ...
  {
    manifestPath:
      process.env.SECURITY_FUNCTION_RECIPE_IMAGE_AUTH_DELETION_CLAIM_MANIFEST_PATH
      ?? path.join(
        REPO_ROOT,
        "docs/security/recipe-image-auth-deletion-claim-security-function-authorization-manifest.json",
      ),
    migrationPath:
      process.env.SECURITY_FUNCTION_RECIPE_IMAGE_AUTH_DELETION_CLAIM_MIGRATION_PATH
      ?? path.join(
        REPO_ROOT,
  ...
  {
    manifestPath:
      process.env.SECURITY_FUNCTION_RECIPE_IMAGE_AUTH_DELETION_FINALIZE_MANIFEST_PATH
      ?? path.join(
        REPO_ROOT,
        "docs/security/recipe-image-auth-deletion-finalize-security-function-authorization-manifest.json",
      ),
    migrationPath:
      process.env.SECURITY_FUNCTION_RECIPE_IMAGE_AUTH_DELETION_FINALIZE_MIGRATION_PATH
      ?? path.join(
        REPO_ROOT,
  ...
  {
    manifestPath:
      process.env.SECURITY_FUNCTION_RECIPE_IMAGE_AUTH_DELETION_CANDIDATE_MANIFEST_PATH
      ?? path.join(
        REPO_ROOT,
        "docs/security/recipe-image-auth-deletion-candidate-security-function-authorization-manifest.json",
      ),
    migrationPath:
      process.env.SECURITY_FUNCTION_RECIPE_IMAGE_AUTH_DELETION_CANDIDATE_MIGRATION_PATH
      ?? path.join(
        REPO_ROOT,
  ...
  {
    manifestPath:
      process.env.SECURITY_FUNCTION_RECIPE_IMAGE_LIFECYCLE_COMPLETION_CANDIDATE_MANIFEST_PATH
      ?? path.join(
        REPO_ROOT,
        "docs/security/recipe-image-lifecycle-completion-candidate-security-function-authorization-manifest.json",
      ),
    migrationPath:
      process.env.SECURITY_FUNCTION_RECIPE_IMAGE_LIFECYCLE_COMPLETION_CANDIDATE_MIGRATION_PATH
      ?? path.join(
        REPO_ROOT,
  ...
  {
    manifestPath:
      process.env.SECURITY_FUNCTION_RECIPE_IMAGE_COMPACT_RETENTION_MANIFEST_PATH
      ?? path.join(
        REPO_ROOT,
        "docs/security/recipe-image-compact-retention-security-function-authorization-manifest.json",
      ),
    migrationPath:
      process.env.SECURITY_FUNCTION_RECIPE_IMAGE_COMPACT_RETENTION_MIGRATION_PATH
      ?? path.join(
        REPO_ROOT,
  ...
  },
  {
    ...
    migrationPath:
      process.env.SECURITY_FUNCTION_RECIPE_IMAGE_READ_PROJECTION_MIGRATION_PATH
      ?? path.join(
        REPO_ROOT,
