...
function printUsage() {
  process.stdout.write(
    [
      ...
      "  pnpm omo:promotion:update -- --section operational-gate --id scheduler-standard --status pass --evidence-ref .opencode/README.md --evidence-ref docs/engineering/workflow-v2/promotion-readiness.md --note \"launchd default, fallback commands, and verify cadence locked\"",
