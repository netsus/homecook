...
const ROUTE_METADATA_BY_KEY = {
  ...
  "POST /api/v1/cooking/session-attempts": { owner_scope: "authenticated-user", persists_personal_state: true },
  "POST /api/v1/cooking/session-attempts/[id]/cancel": { owner_scope: "authenticated-user", persists_personal_state: true },
  "POST /api/v1/cooking/session-attempts/[id]/complete": { owner_scope: "authenticated-user", persists_personal_state: true },
  "PATCH /api/v1/cooked-batches/[id]/weight": { owner_scope: "authenticated-user", persists_personal_state: true },
  "POST /api/v1/cooked-batches/[id]/discard": { owner_scope: "authenticated-user", persists_personal_state: true },
  ...
  "POST /api/v1/meal-log/entries": { owner_scope: "authenticated-user", persists_personal_state: true },
  "PATCH /api/v1/meal-log/entries/[id]": { owner_scope: "authenticated-user", persists_personal_state: true },
  "DELETE /api/v1/meal-log/entries/[id]": { owner_scope: "authenticated-user", persists_personal_state: true },
  ...
  "PATCH /api/v1/recipes/[id]": { owner_scope: "authenticated-user", persists_personal_state: true },
  "DELETE /api/v1/recipes/[id]": { owner_scope: "authenticated-user", persists_personal_state: true },
  "POST /api/v1/recipes/[id]/future-plan-impact": { owner_scope: "authenticated-user", persists_personal_state: false },
...
const LIB_FILE_OWNER_SCOPE = {
  ...
  "lib/server/meal-log.ts": "authenticated-user",
