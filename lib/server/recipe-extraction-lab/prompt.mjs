...
export const PROMPT_VERSION = "step-source-amount-coverage-2";
...
4. 재료(ingredients): 조리에 실제로 쓰이는 식재료·양념만. name은 한국어 표준명, 외국어·원문 표기는 nameAliases에. 만들기 단계에 등장하지 않는 재료는 넣지 마라. 설명란·댓글·자막에 "재료명 수량단위" 목록이 있으면 먼저 그 목록을 훑고, 실제 조리 장면에 쓰인 항목만 recipes[].ingredients에 반영한다.
