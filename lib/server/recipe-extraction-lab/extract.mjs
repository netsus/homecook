...
export async function extractRecipeFromSources(input, deps) {
  ...
  const evidencePacketBundle = useEvidencePackets ? buildEvidencePacketBundle(input) : null;
  const sendVideoUrl = Boolean(useVisual && youtubeUrl && !(useEvidencePackets && packetPromptTextOnly));
