...
export const PUBLIC_SOURCE_PACKET_VERSION = "public-source-packet-v4-explicit-boundaries";
...
function deriveSubtitleMarkerTitle() {
  // Strict i031 uses source-text/single mode. Keep public-source title recovery inert.
  return "";
}
...
function titleParts(title) {
  ...
  const parts = separatorParts.length > 1 ? separatorParts : [];
  if (parts.length > 0) {
    const seen = new Set();
    return parts
