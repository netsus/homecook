...
export const SERVICE_GUIDE_GUIDES = [
  ...
  },
  {
    ...
    steps: ["플래너의 요리는 장보기를 완료한 뒤 시작해요. 레시피 상세에서 시작하는 바로 요리는 계획과 독립적이에요.", "재료와 조리순서를 보면서 요리하고, 완료할 때 완성된 음식의 전체 무게를 g(그램)으로 입력해요.", "완성 무게를 기록하면 나눠 먹은 양에 맞게 영양을 계산할 수 있어요. 이전 방식의 요리는 재료 중량과 영양정보가 모두 확인되는 경우에만 재료 중량 기준으로 계산해요."],
  },
  {
  ...
  },
  {
    ...
    steps: ["남은요리에서 요리한 음식과 남은 양을 확인해요.", "다음 끼니의 식사 기록에서 같은 요리한 음식을 고르고 이번에 먹은 g을 입력해요.", "무게로 관리하는 요리는 기록한 만큼 남은 양에 반영돼요. 이전 방식의 요리는 남은 양을 추정하지 않으며, 재료 중량 기준의 영양 계산은 완성 무게를 잰 결과와 달라요."],
...
export const SERVICE_GUIDE_FAQS = [
  ...
  { id: "faq-preparing", title: "지금 어떤 기능을 사용할 수 있나요?", answer: "로그인하면 YouTube 링크로 레시피를 가져오고, 식사 기록의 음식 상세에서 먹은 양을 확인·수정할 수 있어요. 추출 결과는 재료와 양, 조리순서를 확인한 뒤 저장해 주세요. 계획·장보기·요리를 모두 거치지 않아도 제품이나 식재료를 식사 기록에 바로 추가할 수 있어요." },
