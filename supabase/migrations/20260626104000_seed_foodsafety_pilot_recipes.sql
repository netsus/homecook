...
탄산수 50ml, 어간장 5g'::text, '{"source_provider":"foodsafety-cookrcp","source_recipe_id":"386","candidate_id":"foodsafety-cookrcp:386","pilot_order":2,"external_category":"일품","source_method_label":"기타","source_image_url":"http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00386_1.png","nutrition":{"serving_weight":null,"calories":"36.9","carbohydrates":"6.1","protein":"0.1","fat":"1.4","sodium":"490.7"},"reviewed_scope":"pilot_30_user_reviewed","reviewed_at":"2026-06-26T00:00:00.000Z"}'::jsonb),
  ('298da2db-51e4-50da-9295-034d6e77045b'::uuid, '된장국'::text, '국&찌개 · 식약처 공공 레시피'::text, 'http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00037_2.png'::text, 1::integer, '37'::text, 'foodsafety-cookrcp:37'::text, array['공공레시피', '식약처레시피', '국물요리', '고단백', '한식']::text[], '된장국
두부 20g(2×2×2cm), 애느타리버섯 20g(4가닥), 감자 10g(4×3×1cm), 양파 10g(2×1cm), 대파 10g(5cm), 된장 5g(1작은술), 물 300ml(1½컵)'::text, '{"source_provider":"foodsafety-cookrcp","source_recipe_id":"37","candidate_id":"foodsafety-cookrcp:37","pilot_order":3,"external_category":"국&찌개","source_method_label":"끓이기","source_image_url":"http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00037_1.png","nutrition":{"serving_weight":null,"calories":"20","carbohydrates":"3","protein":"2","fat":"0","sodium":"260"},"reviewed_scope":"pilot_30_user_reviewed","reviewed_at":"2026-06-26T00:00:00.000Z"}'::jsonb),
  ('8a680421-7dad-54c1-8815-83f65908187c'::uuid, '백김치콩비지찌개'::text, '국&찌개 · 식약처 공공 레시피'::text, 'http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00273_2.png'::text, 1::integer, '273'::text, 'foodsafety-cookrcp:273'::text, array['공공레시피', '식약처레시피', '국물요리', '한식']::text[], '재료 풋고추(10g), 백김치(100g), 콩비지(100g)
양념 참기름(8g), 후춧가루(0.2g), 다진 마늘(10g), 간장(2g)'::text, '{"source_provider":"foodsafety-cookrcp","source_recipe_id":"273","candidate_id":"foodsafety-cookrcp:273","pilot_order":4,"external_category":"국&찌개","source_method_label":"끓이기","source_image_url":"http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00273_1.png","nutrition":{"serving_weight":null,"calories":"195.3","carbohydrates":"3.13","protein":"2.99","fat":"2.99","sodium":"447.2"},"reviewed_scope":"pilot_30_user_reviewed","reviewed_at":"2026-06-26T00:00:00.000Z"}'::jsonb),
  ('12dbf6ae-8783-52c6-a1e4-8280fcfe16b2'::uuid, '근채류주먹밥'::text, '밥 · 식약처 공공 레시피'::text, 'http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00337_2.png'::text, 1::integer, '337'::text, 'foodsafety-cookrcp:337'::text, array['공공레시피', '식약처레시피', '한그릇요리', '한식']::text[], '우엉 20g, 연근 20g, 감자 20g, 청고추 10g, 양파 10g, 당근 10g
쌀 100g, 오이 70g, 통깨 1g, 맛간장 15g, 참기름 5g, 마늘기름 15g, 함초소금 2g'::text, '{"source_provider":"foodsafety-cookrcp","source_recipe_id":"337","candidate_id":"foodsafety-cookrcp:337","pilot_order":5,"external_category":"밥","source_method_label":"볶기","source_image_url":"http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00337_1.png","nutrition":{"serving_weight":null,"calories":"117.3","carbohydrates":"25.2","protein":"2.4","fat":"0.8","sodium":"11.3"},"reviewed_scope":"pilot_30_user_reviewed","reviewed_at":"2026-06-26T00:00:00.000Z"}'::jsonb),
  ('0a54f6c0-0ac3-59ea-97f9-4b4f58156ecf'::uuid, '삼색샌드위치'::text, '일품 · 식약처 공공 레시피'::text, 'http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00441_2.png'::text, 1::integer, '441'::text, 'foodsafety-cookrcp:441'::text, array['공공레시피', '식약처레시피', '한그릇요리', '고단백']::text[], '식빵(100g), 토마토(20g), 어린이치즈(20g), 양상추(30g)
...
양파(20g), 소금(0.3g)'::text, '{"source_provider":"foodsafety-cookrcp","source_recipe_id":"441","candidate_id":"foodsafety-cookrcp:441","pilot_order":6,"external_category":"일품","source_method_label":"기타","source_image_url":"http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00441_1.png","nutrition":{"serving_weight":null,"calories":"356.4","carbohydrates":"47.9","protein":"14.1","fat":"12.4","sodium":"497.3"},"reviewed_scope":"pilot_30_user_reviewed","reviewed_at":"2026-06-26T00:00:00.000Z"}'::jsonb),
  ('c2693c74-4109-5f64-8a69-865acd0ef77f'::uuid, '새우아욱죽'::text, '밥 · 식약처 공공 레시피'::text, 'http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00395_2.png'::text, 1::integer, '395'::text, 'foodsafety-cookrcp:395'::text, array['공공레시피', '식약처레시피', '한그릇요리', '다이어트', '한식']::text[], '귀리밥 100g, 아욱 30g, 건새우 25g, 칵테일새우 25g, 저염 된장 30g'::text, '{"source_provider":"foodsafety-cookrcp","source_recipe_id":"395","candidate_id":"foodsafety-cookrcp:395","pilot_order":7,"external_category":"밥","source_method_label":"끓이기","source_image_url":"http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00395_1.png","nutrition":{"serving_weight":null,"calories":"201.3","carbohydrates":"34","protein":"13.1","fat":"1.4","sodium":"471.6"},"reviewed_scope":"pilot_30_user_reviewed","reviewed_at":"2026-06-26T00:00:00.000Z"}'::jsonb),
  ('a5a7fc1e-ceef-5970-9a85-b60377ce72f8'::uuid, '연어오븐구이'::text, '일품 · 식약처 공공 레시피'::text, 'http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00571_2.png'::text, 1::integer, '571'::text, 'foodsafety-cookrcp:571'::text, array['공공레시피', '식약처레시피', '한그릇요리']::text[], '연어(150g), 양파(50g), 토마토(100g), 파프리카(50g),
당근(30g), 마늘(20g), 청피망(30g), 레몬(1/4개), 소금(0.3g),
후춧가루(0.01g), 생크림(20g), 화이트크림(50g), 버터(20g)'::text, '{"source_provider":"foodsafety-cookrcp","source_recipe_id":"571","candidate_id":"foodsafety-cookrcp:571","pilot_order":8,"external_category":"일품","source_method_label":"볶기","source_image_url":"http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00571_1.png","nutrition":{"serving_weight":null,"calories":"285.9","carbohydrates":"8.1","protein":"28.7","fat":"15.4","sodium":"222.1"},"reviewed_scope":"pilot_30_user_reviewed","reviewed_at":"2026-06-26T00:00:00.000Z"}'::jsonb),
  ('ff795de4-16d5-563c-af83-9fd8c4a9fda4'::uuid, '고추김치'::text, '반찬 · 식약처 공공 레시피'::text, 'http://www.foodsafetykorea.go.kr/uploadimg/20230306/20230306052031_1678090831734.jpg'::text, 1::integer, '399'::text, 'foodsafety-cookrcp:399'::text, array['공공레시피', '식약처레시피', '밑반찬', '매콤', '한식']::text[], '•필수재료 : 오이고추(40g), 영양부추(5g), 연근(5g), 무(5g)
•절임물 : 해물육수(8g), 어간장(3g)
...
●간장 레몬 소스 : 저염간장 5g(1작은술), 식초 15g(1큰술), 설탕 10g(1큰술), 레몬즙 5g(1작은술)'::text, '{"source_provider":"foodsafety-cookrcp","source_recipe_id":"93","candidate_id":"foodsafety-cookrcp:93","pilot_order":10,"external_category":"반찬","source_method_label":"굽기","source_image_url":"http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00093_1.png","nutrition":{"serving_weight":null,"calories":"175","carbohydrates":"19","protein":"4","fat":"9","sodium":"38"},"reviewed_scope":"pilot_30_user_reviewed","reviewed_at":"2026-06-26T00:00:00.000Z"}'::jsonb),
  ('d6b476b5-7b6f-5a68-8f61-55ae8f00a783'::uuid, '매실동치미'::text, '반찬 · 식약처 공공 레시피'::text, 'http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00415_2.png'::text, 1::integer, '415'::text, 'foodsafety-cookrcp:415'::text, array['공공레시피', '식약처레시피', '밑반찬', '한식']::text[], '무 50g, 연근 25g, 사과 25g, 배 30g, 함초소금 2g
국물 : 매실청 30g, 생강청 15g, 함초소금 1g, 청양고추 10g'::text, '{"source_provider":"foodsafety-cookrcp","source_recipe_id":"415","candidate_id":"foodsafety-cookrcp:415","pilot_order":11,"external_category":"반찬","source_method_label":"기타","source_image_url":"http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00415_1.png","nutrition":{"serving_weight":null,"calories":"76.8","carbohydrates":"18.4","protein":"0.7","fat":"0","sodium":"79.2"},"reviewed_scope":"pilot_30_user_reviewed","reviewed_at":"2026-06-26T00:00:00.000Z"}'::jsonb),
  ('2af320dd-544b-58df-8c9d-8a9a8d5fc585'::uuid, '방울토마토 소박이'::text, '반찬 · 식약처 공공 레시피'::text, 'http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00031_2.png'::text, 1::integer, '31'::text, 'foodsafety-cookrcp:31'::text, array['공공레시피', '식약처레시피', '밑반찬', '한식']::text[], '●방울토마토 소박이 : 
...
고춧가루 4g(1작은술), 멸치액젓 3g(2/3작은술), 다진 마늘 2.5g(1/2쪽), 매실액 2g(1/3작은술), 설탕 2g(1/3작은술), 물 2ml(1/3작은술), 통깨 약간'::text, '{"source_provider":"foodsafety-cookrcp","source_recipe_id":"31","candidate_id":"foodsafety-cookrcp:31","pilot_order":12,"external_category":"반찬","source_method_label":"기타","source_image_url":"http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00031_1.png","nutrition":{"serving_weight":null,"calories":"45","carbohydrates":"9","protein":"2","fat":"1","sodium":"277"},"reviewed_scope":"pilot_30_user_reviewed","reviewed_at":"2026-06-26T00:00:00.000Z"}'::jsonb),
  ('72307be5-40e0-5fa3-a7f1-e350b02b445d'::uuid, '단호박소고기롤'::text, '반찬 · 식약처 공공 레시피'::text, 'http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00537_2.png'::text, 1::integer, '537'::text, 'foodsafety-cookrcp:537'::text, array['공공레시피', '식약처레시피', '밑반찬', '고단백', '한식']::text[], '소고기(70g), 저염간장(10g), 다진 마늘(10g), 설탕(10g)
파프리카(30g), 오이(20g), 적양배추(20g), 사과(20g)
설탕(10g), 팽이버섯(20g), 무순(5g)
- 밀전병 : 단호박(100g), 밀가루(50g), 소금(0.5g)
- 소스 : 다진 마늘(10g), 다진 양파(20g), 올리브오일(20g)
설탕(10g), 식초(20g), 소금(0.5g)'::text, '{"source_provider":"foodsafety-cookrcp","source_recipe_id":"537","candidate_id":"foodsafety-cookrcp:537","pilot_order":13,"external_category":"반찬","source_method_label":"굽기","source_image_url":"http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00537_1.png","nutrition":{"serving_weight":null,"calories":"444.9","carbohydrates":"66.9","protein":"10.2","fat":"15.2","sodium":"248.3"},"reviewed_scope":"pilot_30_user_reviewed","reviewed_at":"2026-06-26T00:00:00.000Z"}'::jsonb),
  ('f8f195c4-b7d7-58da-bd81-07d35357db59'::uuid, '돌나물 샐러드'::text, '반찬 · 식약처 공공 레시피'::text, 'http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00074_2.png'::text, 1::integer, '74'::text, 'foodsafety-cookrcp:74'::text, array['공공레시피', '식약처레시피', '밑반찬', '샐러드', '다이어트', '한식']::text[], '●돌나물 샐러드 : 돌나물 90g, 미니새송이버섯 60g(7개), 참기름 약간
●레몬마요네즈 소스 : 마요네즈 10g(2작은술), 레몬즙 20g(1⅓큰술), 청양고추 5g(1/2개), 홍고추 5g(1/2개), 참기름 약간'::text, '{"source_provider":"foodsafety-cookrcp","source_recipe_id":"74","candidate_id":"foodsafety-cookrcp:74","pilot_order":14,"external_category":"반찬","source_method_label":"기타","source_image_url":"http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00074_1.png","nutrition":{"serving_weight":null,"calories":"235","carbohydrates":"2","protein":"3","fat":"24","sodium":"151"},"reviewed_scope":"pilot_30_user_reviewed","reviewed_at":"2026-06-26T00:00:00.000Z"}'::jsonb),
  ('7e169300-b4d5-5a14-9b31-aa989035d862'::uuid, '두부 카프리제'::text, '반찬 · 식약처 공공 레시피'::text, 'http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00587_2.png'::text, 1::integer, '587'::text, 'foodsafety-cookrcp:587'::text, array['공공레시피', '식약처레시피', '밑반찬', '고단백', '한식']::text[], '소고기(100g), 돼지고기(100g), 표고버섯(2개), 마(100g),
...
두유(100g), 설탕(20g), 소금(0.2g), 저염간장(20g)'::text, '{"source_provider":"foodsafety-cookrcp","source_recipe_id":"587","candidate_id":"foodsafety-cookrcp:587","pilot_order":15,"external_category":"반찬","source_method_label":"기타","source_image_url":"http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00587_1.png","nutrition":{"serving_weight":null,"calories":"140.2","carbohydrates":"6.8","protein":"11.1","fat":"7.6","sodium":"229.6"},"reviewed_scope":"pilot_30_user_reviewed","reviewed_at":"2026-06-26T00:00:00.000Z"}'::jsonb),
  ('dc2c7bf6-2470-5dbf-bca5-08c56b6fa10a'::uuid, '토마토 가지 카프레제'::text, '후식 · 식약처 공공 레시피'::text, 'http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00202_2.png'::text, 1::integer, '202'::text, 'foodsafety-cookrcp:202'::text, array['공공레시피', '식약처레시피', '디저트']::text[], '●주재료 : 가지 100g(1개), 토마토 200g(1½개), 무순 20g, 마늘 10g(2개), 올리브오일 5g(1작은술)
●드레싱 : 올리브오일 25g(2큰술), 발사믹식초 60g(4큰술), 후춧가루 2g(1/2작은술)'::text, '{"source_provider":"foodsafety-cookrcp","source_recipe_id":"202","candidate_id":"foodsafety-cookrcp:202","pilot_order":16,"external_category":"후식","source_method_label":"굽기","source_image_url":"http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00202_1.png","nutrition":{"serving_weight":null,"calories":"90.5","carbohydrates":"7.4","protein":"1.2","fat":"6.2","sodium":"11.3"},"reviewed_scope":"pilot_30_user_reviewed","reviewed_at":"2026-06-26T00:00:00.000Z"}'::jsonb),
  ('bf0b1e5e-df1c-5293-843a-47f835040c72'::uuid, '치즈감자크로켓'::text, '후식 · 식약처 공공 레시피'::text, 'http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00502_2.png'::text, 1::integer, '502'::text, 'foodsafety-cookrcp:502'::text, array['공공레시피', '식약처레시피', '디저트', '고단백']::text[], '감자(150g), 생크림(20g), 당근(20g), 양파(20g), 오이(20g)
소금(0.5g), 모짜렐라치즈(50g), 밀가루(20g), 달걀(50g)
빵가루(50g), 튀김기름(400g)'::text, '{"source_provider":"foodsafety-cookrcp","source_recipe_id":"502","candidate_id":"foodsafety-cookrcp:502","pilot_order":17,"external_category":"후식","source_method_label":"튀기기","source_image_url":"http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00502_1.png","nutrition":{"serving_weight":null,"calories":"588.5","carbohydrates":"40.1","protein":"14.8","fat":"41","sodium":"362.3"},"reviewed_scope":"pilot_30_user_reviewed","reviewed_at":"2026-06-26T00:00:00.000Z"}'::jsonb),
  ('b1e4550e-f9a9-516a-b11b-29a410ade9d9'::uuid, '민들레 샐러드'::text, '반찬 · 식약처 공공 레시피'::text, 'http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00201_2.png'::text, 1::integer, '201'::text, 'foodsafety-cookrcp:201'::text, array['공공레시피', '식약처레시피', '밑반찬', '샐러드', '다이어트', '한식']::text[], '●주재료 : 민들레 잎 40g, 비트 5g(1작은술), 오렌지(껍질) 40g(1/5개)
●드레싱 : 간장 20g(1⅓큰술), 다진 홍고추 10g(1개), 레몬즙 60g(4큰술), 설탕 6g(1작은술)'::text, '{"source_provider":"foodsafety-cookrcp","source_recipe_id":"201","candidate_id":"foodsafety-cookrcp:201","pilot_order":18,"external_category":"반찬","source_method_label":"기타","source_image_url":"http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00201_1.png","nutrition":{"serving_weight":null,"calories":"53.9","carbohydrates":"10.9","protein":"2.4","fat":"0","sodium":"874.2"},"reviewed_scope":"pilot_30_user_reviewed","reviewed_at":"2026-06-26T00:00:00.000Z"}'::jsonb),
  ('2240c082-e0cb-5eda-9ce8-4e9d1c4b52c8'::uuid, '새우 두부 계란찜'::text, '반찬 · 식약처 공공 레시피'::text, 'http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00028_2.png'::text, 1::integer, '28'::text, 'foodsafety-cookrcp:28'::text, array['공공레시피', '식약처레시피', '밑반찬', '고단백', '한식']::text[], '새우두부계란찜
연두부 75g(3/4모), 칵테일새우 20g(5마리), 달걀 30g(1/2개), 생크림 13g(1큰술), 설탕 5g(1작은술), 무염버터 5g(1작은술)
고명
시금치 10g(3줄기)'::text, '{"source_provider":"foodsafety-cookrcp","source_recipe_id":"28","candidate_id":"foodsafety-cookrcp:28","pilot_order":19,"external_category":"반찬","source_method_label":"찌기","source_image_url":"http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00028_1.png","nutrition":{"serving_weight":null,"calories":"220","carbohydrates":"3","protein":"14","fat":"17","sodium":"99"},"reviewed_scope":"pilot_30_user_reviewed","reviewed_at":"2026-06-26T00:00:00.000Z"}'::jsonb),
  ('4358a8a3-cac1-5173-86df-ee15a5960131'::uuid, '석류 보쌈김치'::text, '반찬 · 식약처 공공 레시피'::text, 'http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00159_2.png'::text, 1::integer, '159'::text, 'foodsafety-cookrcp:159'::text, array['공공레시피', '식약처레시피', '밑반찬', '한식']::text[], '●주재료 : 배추 70g(1/10개), 석류즙 10g(2작은술), 소금 5g(1/2작은술)
●양념 : 무 10g(3cm), 미나리 10g, 쪽파 10g(1개), 다진 마늘 5g(1작은술), 다진 생강 5g(1작은술), 새우젓국 15g(1큰술)'::text, '{"source_provider":"foodsafety-cookrcp","source_recipe_id":"159","candidate_id":"foodsafety-cookrcp:159","pilot_order":20,"external_category":"반찬","source_method_label":"기타","source_image_url":"http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00159_1.png","nutrition":{"serving_weight":null,"calories":"24.5","carbohydrates":"4.7","protein":"1.4","fat":"0","sodium":"171.3"},"reviewed_scope":"pilot_30_user_reviewed","reviewed_at":"2026-06-26T00:00:00.000Z"}'::jsonb),
  ('e168bb81-7c6b-5b96-b111-8c53fb8f0336'::uuid, '스트로베리 샐러드'::text, '반찬 · 식약처 공공 레시피'::text, 'http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00087_2.png'::text, 1::integer, '87'::text, 'foodsafety-cookrcp:87'::text, array['공공레시피', '식약처레시피', '밑반찬', '샐러드', '다이어트', '한식']::text[], '스트로베리 샐러드
...
●소스 : 오렌지즙 15g(1큰술), 간장 2g(1/2작은술), 식초 10g(2작은술)'::text, '{"source_provider":"foodsafety-cookrcp","source_recipe_id":"181","candidate_id":"foodsafety-cookrcp:181","pilot_order":24,"external_category":"반찬","source_method_label":"굽기","source_image_url":"http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00181_1.png","nutrition":{"serving_weight":null,"calories":"148.9","carbohydrates":"14.7","protein":"7.7","fat":"6.6","sodium":"107.1"},"reviewed_scope":"pilot_30_user_reviewed","reviewed_at":"2026-06-26T00:00:00.000Z"}'::jsonb),
  ('ef8a2ea5-848a-5a09-9525-26a233911832'::uuid, '연근부각'::text, '반찬 · 식약처 공공 레시피'::text, 'http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00665_2.png'::text, 1::integer, '665'::text, 'foodsafety-cookrcp:665'::text, array['공공레시피', '식약처레시피', '밑반찬', '한식']::text[], '연근(60g), 식초(10g), 천일염(0.1g), 계피가루(20g),
식용유(200g)'::text, '{"source_provider":"foodsafety-cookrcp","source_recipe_id":"665","candidate_id":"foodsafety-cookrcp:665","pilot_order":25,"external_category":"반찬","source_method_label":"튀기기","source_image_url":"http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00665_1.png","nutrition":{"serving_weight":null,"calories":"162.2","carbohydrates":"25.3","protein":"2.6","fat":"5.6","sodium":"67.7"},"reviewed_scope":"pilot_30_user_reviewed","reviewed_at":"2026-06-26T00:00:00.000Z"}'::jsonb),
  ('b7badda4-d285-5b6d-8c61-81d387f137ed'::uuid, '연근초무침'::text, '반찬 · 식약처 공공 레시피'::text, 'http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00419_2.png'::text, 1::integer, '419'::text, 'foodsafety-cookrcp:419'::text, array['공공레시피', '식약처레시피', '밑반찬', '한식']::text[], '연근 200g, 양파 60g, 오이 40g, 밤 60g
소스 : 유자청 25g, 강황가루 2g, 잣 2g, 설탕 5g, 식초 15g'::text, '{"source_provider":"foodsafety-cookrcp","source_recipe_id":"419","candidate_id":"foodsafety-cookrcp:419","pilot_order":26,"external_category":"반찬","source_method_label":"기타","source_image_url":"http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00419_1.png","nutrition":{"serving_weight":null,"calories":"119.1","carbohydrates":"20.4","protein":"1.6","fat":"3.5","sodium":"81.4"},"reviewed_scope":"pilot_30_user_reviewed","reviewed_at":"2026-06-26T00:00:00.000Z"}'::jsonb),
  ('83cea47d-8eab-5799-b70d-649f2e17c5ad'::uuid, '연어차우더스프'::text, '일품 · 식약처 공공 레시피'::text, 'http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00514_2.png'::text, 1::integer, '514'::text, 'foodsafety-cookrcp:514'::text, array['공공레시피', '식약처레시피', '한그릇요리']::text[], '모시조개(50g), 연어(100g), 청피망(20g), 당근(20g)
양파(20g), 감자(50g), 밀가루(10g), 버터(5g), 육수(200g)
월계수잎(1장), 통후추(3알), 생크림(30g), 통마늘(10g)'::text, '{"source_provider":"foodsafety-cookrcp","source_recipe_id":"514","candidate_id":"foodsafety-cookrcp:514","pilot_order":27,"external_category":"일품","source_method_label":"끓이기","source_image_url":"http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00514_1.png","nutrition":{"serving_weight":null,"calories":"217.6","carbohydrates":"23.2","protein":"11.7","fat":"8.7","sodium":"215.4"},"reviewed_scope":"pilot_30_user_reviewed","reviewed_at":"2026-06-26T00:00:00.000Z"}'::jsonb),
  ('8cb5c8e7-7566-5a93-ba06-28d3d3ad12bb'::uuid, '열무김치파스타'::text, '일품 · 식약처 공공 레시피'::text, 'http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00330_2.png'::text, 1::integer, '330'::text, 'foodsafety-cookrcp:330'::text, array['공공레시피', '식약처레시피', '한그릇요리', '면요리', '한식']::text[], '파스타면 50g, 열무김치 100g, 오이 20g, 청홍고추 각각 15g
노란 파프리카 30g, 양파 30g, 당근 25g
생들기름 30g, 통깨 2g, 청양고추 30g'::text, '{"source_provider":"foodsafety-cookrcp","source_recipe_id":"330","candidate_id":"foodsafety-cookrcp:330","pilot_order":28,"external_category":"일품","source_method_label":"볶기","source_image_url":"http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00330_1.png","nutrition":{"serving_weight":null,"calories":"270.4","carbohydrates":"42.1","protein":"6.6","fat":"8.4","sodium":"371"},"reviewed_scope":"pilot_30_user_reviewed","reviewed_at":"2026-06-26T00:00:00.000Z"}'::jsonb),
  ('7da19cdd-f8f9-59d6-9583-378b0225b5f5'::uuid, '오징어콩순대'::text, '일품 · 식약처 공공 레시피'::text, 'http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00390_2.png'::text, 1::integer, '390'::text, 'foodsafety-cookrcp:390'::text, array['공공레시피', '식약처레시피', '한그릇요리']::text[], '오징어 1마리(220g), 옥수수 30g, 귀리밥 50g, 강낭콩 20g
당근 20g, 미니파프리카 20g, 피망 20g, 대파 10g, 양파 25g
카레가루 25g, 흰후추 1g, 다진마늘 5g, 참기름 15g, 밀가루 15g, 레몬즙 15g'::text, '{"source_provider":"foodsafety-cookrcp","source_recipe_id":"390","candidate_id":"foodsafety-cookrcp:390","pilot_order":29,"external_category":"일품","source_method_label":"굽기","source_image_url":"http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00390_1.png","nutrition":{"serving_weight":null,"calories":"213.5","carbohydrates":"25","protein":"17.9","fat":"4.7","sodium":"295.4"},"reviewed_scope":"pilot_30_user_reviewed","reviewed_at":"2026-06-26T00:00:00.000Z"}'::jsonb),
  ('381fb996-b8ab-5a0e-84fe-401a9ddb5387'::uuid, '전복리조또'::text, '밥 · 식약처 공공 레시피'::text, 'http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00576_2.png'::text, 1::integer, '576'::text, 'foodsafety-cookrcp:576'::text, array['공공레시피', '식약처레시피', '한그릇요리', '한식']::text[], '쌀(100g), 전복(1개), 당근(20g), 양파(30g), 양송이버섯(3개),
우유(200g), 올리브오일(10g), 소금(0.2g), 후춧가루(0.01g),
버터(10g)'::text, '{"source_provider":"foodsafety-cookrcp","source_recipe_id":"576","candidate_id":"foodsafety-cookrcp:576","pilot_order":30,"external_category":"밥","source_method_label":"끓이기","source_image_url":"http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00576_1.png","nutrition":{"serving_weight":null,"calories":"282.9","carbohydrates":"53.1","protein":"7.1","fat":"4.7","sodium":"92.1"},"reviewed_scope":"pilot_30_user_reviewed","reviewed_at":"2026-06-26T00:00:00.000Z"}'::jsonb);
...
values
  ...
  ('9e9e82c1-f7bc-5372-9588-0f242cc8239d'::uuid, 6::integer, '레몬즙'::text, 3::numeric, 'g'::varchar, 'QUANT'::public.recipe_ingredient_type, '통깨 3g'::varchar, null::text, true::boolean),
  ...
  ('8a680421-7dad-54c1-8815-83f65908187c'::uuid, 1::integer, '물'::text, 200::numeric, 'g'::varchar, 'QUANT'::public.recipe_ingredient_type, '다진 마늘(10g)'::varchar, '양념'::text, true::boolean),
...
values
  ...
  ('12dbf6ae-8783-52c6-a1e4-8280fcfe16b2'::uuid, 5::integer, '그 릇 에 모 든 재 료 를 넣 고 오 니 기 리 를 만들어준다.'::text, null::text, '볶기'::text),
  ...
  ('426ae2a2-04f0-552d-98e8-6c6d144bc1f7'::uuid, 3::integer, '가지, 호박, 새송이버섯, 양파, 파프리카, 피망에 올리브유를 바르고 달궈진 그릴 팬에 구운 후 접시에 담고 발사믹 크레타를 뿌리고 간장레몬 소스를 곁들인다.'::text, null::text, '굽기'::text),
  ...
  ('2240c082-e0cb-5eda-9ce8-4e9d1c4b52c8'::uuid, 1::integer, '손질된 새우를 끓는 물에 데쳐 건진다.a'::text, null::text, '찌기'::text),
  ('2240c082-e0cb-5eda-9ce8-4e9d1c4b52c8'::uuid, 2::integer, '연두부, 달걀, 생크림, 설탕에 녹인 무염버터를 믹서에 넣고 간 뒤 새우(1)를 함께 섞어 그릇에 담는다.b'::text, null::text, '찌기'::text),
  ('2240c082-e0cb-5eda-9ce8-4e9d1c4b52c8'::uuid, 3::integer, '시금치를 잘게 다져 혼합물 그릇(2)에 뿌리고 찜기에 넣고 중간 불에서 10분 정도 찐다.c'::text, null::text, '찌기'::text),
